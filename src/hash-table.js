...
// If two keys map to the same index in the storage table then you should store a 2d array as the value. 
// Make each key/value pair its own array that is nested inside of the array stored at that index on the table.]
